...
<form action="./includes/uploadkrabbel.inc.php?profiel=<?php echo $profile;
                                                        if ($attached) echo "&attached={$attached}"; if (isset($_GET['krabbelId'])) echo "&krabbelId={$_GET['krabbelId']}"; ?>" class="post side-main-content" method="post" enctype="multipart/form-data" id="form">
  <header>
